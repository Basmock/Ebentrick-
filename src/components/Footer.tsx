    ...
    <footer className="bg-slate-950 text-slate-400 border-t border-slate-800/80 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800/80">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2 space-y-2 text-xs">
              ...
              <div className="flex items-center gap-2 text-slate-300">
                ...
                <a href="tel:+2348032458901" className="hover:text-white font-mono">
                  +234 803 245 8901 (24/7 Hotline)
                </a>
              </div>
              <div className="flex items-center gap-2 text-slate-300">
                <Mail className="w-4 h-4 text-purple-400 flex-shrink-0" />
                <a href="mailto:inquiries@ebentrick.com" className="hover:text-white">
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                className="px-3.5 py-2 rounded-xl text-xs font-bold text-emerald-300 bg-emerald-950/60 border border-emerald-500/30 hover:bg-emerald-900/50 transition-colors inline-flex items-center gap-1.5"
              >
              ...
              <button
                onClick={onOpenAdmin}
                className="px-3 py-2 rounded-xl text-xs font-semibold text-slate-400 hover:text-white bg-slate-900 hover:bg-slate-800 border border-slate-800 transition-colors flex items-center gap-1.5"
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-white font-mono mb-3 flex items-center gap-1.5">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4 text-[11px] font-mono">
            ...
            <span>•</span>
            <span className="text-slate-400">"Light makes the difference"</span>
          </div>
        </div>
      </div>
    </footer>
